					...
					"config": {
						"inbounds": {
							"MORe-display": {
								"semanticObject": "MORe",
								"action": "display",
								"description": "MORe - Monitoring Online Regal",
								"title": "MORe",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tchibo.b2c.mdm.more.ui",
									"url": sap.ui.require.toUrl("tchibo/b2c/mdm/more/ui")
								}
							}
						}
					}
